...
κύριε πρόεδρε θέμα νομίζω πιστεύω κυρία κύριοι κύριος συνάδελφοι συνάδελφε συναδέλφισσα συνάδελφος παρακαλώ παρακαλείται
συγχωρώ διαβάζω διαβάσεις διαβάσει διαβάσω πω πεις πει πούμε πείτε πουν είπα λέω αναφέρω 
αναφέρεις αναφέρει αναφέρουμε αναφέρετε αναφέρουν θέλω θέλεις θέλει υπάρχω υπάρχεις υπάρχει υπάρχουμε υπάρχετε υπάρχουν
υπήρχαν ανακοινώσω ανακοινώσεις ανακοινώσει ανακοινώσουμε ανακοινώσετε ανακοινώσουν ανακοίνωσαν ανακοινώθηκε
θέλουμε θέλετε θέλουν γνωρίζω γνωρίζετε γνωρίζουν γνωρίζεις γνώρισα ξέρω ξέρεις ξέρει ξέρουμε ξέρετε ξέρουν ήξερα
ήξερες ήξερε συμβαίνω συμβαίνεις συμβαίνει έπρεπε μπορώ μπορείς μπορεί μπορούμε μπορείται μπορούν κάνω κάνεις κάνει κάνουμε κάνετε κάνουν
έκανα έκανες έκανε κάναμε κάνατε έκαναν

ησυχία σταμάτα σταματάω σταμάτησε σταματήστε διάβασα καν είπαν είπατε μιλάτε μιλήσατε ησυχάστε ησύχασε διακόπτω διακόπτετε μίλησα ακούσετε ακούω ακούγεστε
ορίστε ζητάτε ζητάω λόγος ζητήστε τέλος φτάνει σταματήστε οδηγώ επιτελώ επιτελείς επιτελεί αναγκασθώ αναγκασθείς μιλήστε
επιμένω επιμένετε επιμένουμε συγχωρήσετε
